export const vi = {
    ...
    hero: {
        ...
        cta1: 'Trải nghiệm RMS miễn phí',
        cta2: 'Đặt lịch tư vấn 15 phút',
        stat1: '50+',
        stat1Label: 'Khách sạn & Resort',
        stat2: '2',
        stat2Label: 'Quốc gia',
        stat3: '20+',
    ...
    howItWorks: {
        ...
        subtitle: 'Từ dùng thử RMS đến tăng trưởng doanh thu toàn diện',
        steps: [
            {
                number: '01',
            ...
            },
            {
                number: '02',
                title: 'Pilot 30 ngày',
                description: '4TK chạy thử chiến lược Sales & Marketing. Bạn thấy kết quả thực tế trước khi cam kết.',
                tag: 'Không cam kết · Không chi phí',
            },
            {
                number: '03',
                title: 'Done-for-you',
                description: 'Chuyển sang mô hình chia % doanh thu. 4TK triển khai full-stack: đội ngũ Sales, Marketing, công nghệ, báo cáo.',
    ...
    model: {
        ...
        transparency: {
            ...
            items: [
                { label: 'Doanh thu tính %', value: 'Doanh thu phòng theo kênh 4TK phụ trách' },
                { label: 'Đối soát', value: 'Hàng tháng · Dữ liệu từ PMS/OTA reports' },
                { label: 'Kiểm soát', value: 'Dashboard realtime · Chốt trong hợp đồng' },
            ],
        },
        mediaCost: {
        ...
        cases: [
            {
                ...
                location: 'Phú Quốc',
                timeline: '6 tháng',
                challenge: 'Tỷ lệ lấp đầy phòng thấp, khó thu hút khách quốc tế',
                results: [
            ...
            },
            {
                ...
                location: 'Bình Thuận',
                timeline: '3 tháng',
                challenge: 'Resort mới khai trương, chưa có nhận diện thương hiệu',
                results: [
                    { metric: 'OCC', before: '0%', after: '65%' },
                    { metric: 'Thương hiệu', before: 'Chưa có', after: 'Xây dựng từ 0' },
                    { metric: 'Kênh phân phối', before: '0', after: '30+ kênh' },
                ],
            },
        ],
    },
    clients: {
        ...
        testimonial: '"4TK Hospitality giúp chúng tôi giảm rủi ro và tăng trưởng doanh thu bền vững. Mô hình chia % là win-win thực sự."',
        ...
        regions: [
            ...
            { name: 'Khu Vực Khác', hotels: ['Sapa Catchi Hotel', "D'Lecia Hạ Long", 'Temple Danang', 'Parze Ocean'] },
        ],
    },
    team: {
        title: 'Đội Ngũ',
        members: [
            ...
            { name: 'Dat Nguyen', role: 'Marketing Lead', bio: '10+ năm Marketing & Tăng trưởng thương hiệu ngành Du lịch & E-commerce (Vingroup, Tiki).' },
            { name: 'Duc Nguyen', role: 'Director of Sales', bio: 'Co-Founder Kitoek.vn (IDG Venture). Chuyên gia tối ưu OTA khách sạn, resort.' },
        ],
    },
    faq: {
        ...
        items: [
            {
                ...
                a: '% được tính trên doanh thu phòng từ các kênh mà 4TK trực tiếp quản lý và phát triển. Con số cụ thể được thỏa thuận trong hợp đồng, dựa trên quy mô và đặc thù từng khách sạn.',
            },
            {
                q: 'Doanh thu nào được tính cho 4TK?',
                a: 'Chỉ tính doanh thu phòng (room revenue) từ các kênh 4TK phụ trách. Doanh thu F&B, Spa và dịch vụ khác không nằm trong phạm vi tính %.',
            },
            {
                q: 'Nếu khách sạn đã có team Sales & Marketing thì sao?',
                a: '4TK hoạt động như một phần mở rộng của đội ngũ hiện tại. Chúng tôi phụ trách các kênh OTA, B2B và digital marketing, trong khi team nội bộ tập trung offline sales, MICE, corporate.',
            },
            {
                q: 'Ngân sách quảng cáo (ads) ai chi trả?',
                a: '4TK chịu chi phí đội ngũ, tools và tracking. Ngân sách ads (Meta, Google, OTA Ads) do khách sạn thanh toán trực tiếp theo budget duyệt trước hàng tháng, hoặc 4TK ứng trước trong hạn mức thỏa thuận.',
            },
            {
    ...
    leadForm: {
        ...
        fields: {
            ...
            rooms: 'Số phòng',
            occAdr: 'OCC & ADR 30 ngày gần nhất (ước tính)',
            channels: 'Kênh bán chính',
            channelOptions: ['OTA (Booking, Agoda...)', 'Travel Agent', 'Corporate', 'MICE', 'Direct Booking', 'Khác'],
            pms: 'PMS đang dùng (không bắt buộc)',
    ...
    contact: {
        ...
        address: '75/11 Nguyễn Văn Cừ, P.01, Q.5, TP. HCM',
    },
    footer: {
